sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("GeminiSmartTemplate/app", ".html");
		...
		return Opa5.extend("GeminiSmartTemplate.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["GeminiSmartTemplate/localService/mockserver"], function (mockserver) {
