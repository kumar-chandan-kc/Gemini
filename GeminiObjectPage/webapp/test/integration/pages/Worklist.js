		...
		onTheWorklistPage: {
					...
					return this.waitFor(createWaitForItemAtPosition({
						...
						success: function(oTableItem) {
							...
							this.getContext().currentItem = {
								...
								name: oBindingContext.getProperty("ObjectName")
							};
						}
					}));
				},
			...
			assertions: jQuery.extend({
				...
				theTableShouldHaveAllEntries: function() {
					...
					// retrieve all I_SBRCloudQuality to be able to check for the total amount
					this.waitFor(this.createAWaitForAnEntitySet({
						entitySet: "I_SBRCloudQuality",
				...
				iPressOntheActualsRowNavigation: function(sTableId1, sViewId) {
					return this.waitFor({
						viewName: sViewName,
						id: sTableId,
